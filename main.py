...
BOT_TOKEN = "8489527645:AAGokjooAXkg2L6qXhr0ThG1rPahxjEUQ5Q"  # ← NAYA TOKEN DAALO
...
def _info_opts():
    o = _base_opts()
    o.update({"quiet": True, "no_warnings": True, "playlist_items": "0"})
    return o
...
if __name__ == "__main__":
    logger.info("✅ Bot running with Pyrofork...")
    app.run()